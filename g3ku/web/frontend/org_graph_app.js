...
const U = {
    ...
    taskGovernanceDecision: document.getElementById("task-governance-decision"),
...
function finalizeCeoTurn(text, meta = {}) {
    ...
    if (!turn?.textEl || !turn.flowEl) {
        ...
        discardPendingCeoTurns({ force: normalizedSource === "heartbeat", source: normalizedSource });
