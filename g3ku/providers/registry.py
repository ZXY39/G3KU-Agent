...
class ProviderSpec:
    ...
    display_name: str = ""          # shown in `g3ku status`
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # OpenAI Responses: directly call /v1/responses with API Key.
    ProviderSpec(
        name="responses",
        keywords=("responses",),
        env_key="OPENAI_API_KEY",
        ...
        is_local=False,
        detect_by_key_prefix="",
        detect_by_base_keyword="responses",
        default_api_base="",                # user must provide in config
        strip_model_prefix=False,
        model_overrides=(),
        is_direct=True,                     # Direct provider
    ),
