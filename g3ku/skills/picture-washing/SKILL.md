---
name: picture-washing
description: Progressive competitor picture-washing workflow for e-commerce image generation. Use when users provide product image + reference image(s) and want compliant generation prompts and generated image URLs.
---
