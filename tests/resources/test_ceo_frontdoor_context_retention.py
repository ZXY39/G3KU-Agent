...
async def test_prepare_turn_reuses_session_context_window_for_new_user_turn(
    ...
    async def _build_for_ceo(**kwargs):
        ...
        return SimpleNamespace(
            ...
            model_messages=list(kwargs["checkpoint_messages"] or []),
            stable_messages=list(kwargs["checkpoint_messages"] or []),
    ...
    assert captured["checkpoint_messages"] == session._frontdoor_request_body_messages
