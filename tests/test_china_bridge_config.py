...
def test_migrate_config_normalizes_china_bridge_channel_aliases():
    raw = {
        "chinaBridge": {
            ...
            "publicPort": 19999,
            "channels": {
                "wecomApp": {"enabled": True, "token": "demo"},
                "feishuChina": {"enabled": True, "appId": "cli_demo"},
            },
        },
    }
    ...
    assert migrated["china_bridge"]["channels"]["wecom_app"]["token"] == "demo"
    assert migrated["china_bridge"]["channels"]["feishu_china"]["appId"] == "cli_demo"
